...
export function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (tab === 'magic') {
      // Self-serve magic link requests are not yet available. The desk generates
      // links via the admin panel. Show instructions rather than a confusing
      // empty submission.
      setError({
        title: 'Ask the desk for a link',
        body:
          'Magic links are generated by your desk agent and sent directly to you. Contact them and ask for a one-time sign-in link.',
      });
      return;
    }
      ...
      <div className="lg-login__core">
        ...
        <section className="lg-login__right">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            {tab === 'password' ? (
              ...
              <p className="lg-login__explainer">
                Magic links are generated by the desk and delivered to you directly —
                by email, SMS, or any other channel. Ask your desk agent to send you one.
                Once you have the link, open it in this browser.
              </p>
            )}

            <div className="lg-login__actions">
              <button type="submit" className="lg-login__send" disabled={submitting || locked}>
                {tab === 'password' ? 'Sign in' : 'I understand'}{' '}
          ...
          <div className="lg-login__helper">
            ...
            <span>
              {tab === 'magic'
                ? <>Magic links are <b>desk-generated</b> · contact your desk agent to receive one</>
                : <>No password? Switch to <b>Request a link</b> and ask your desk agent</>}
            </span>
          </div>
